...
| ---- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Fundamentals of Neural Networks                  | Coded a MLP from Scratch and Trained it on the MNIST Dataset                                                                                                                                                        |
...
GitHub's notebook viewer doesn't render the Week 2 and Week 3 notebooks correctly. Use the Colab links below instead:

- Week 2: [Colab link](https://colab.research.google.com/drive/1j3e9pnVdBHP1NrxTaOuN0AAg2RoB529T?usp=sharing)
- Week 3: [Colab link](https://colab.research.google.com/drive/1uIoK0CN_574ewqipLJOxZ71rNN6E6B6L?usp=sharing)